...
\fancyhf{}
$if(subtitle)$
  \newcommand{\lheadercontent}{$title$ - $subtitle$}
$else$
  \newcommand{\lheadercontent}{$title$}
$endif$
\lhead{\includegraphics[width=0.4cm]{resources/pizzi-logo.png} $project$ | \lheadercontent}
\rhead{\nouppercase{\leftmark}}
